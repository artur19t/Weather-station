...
// Standard ASCII 8x8 font (0x20-0x7F)
// Each character is 8 bytes tall, each byte = 1 row (LSB -> left pixel)
...
const uint8_t font8x8[][8] = {
    ...
    // ,
    {0x00,0x00,0x00,0x00,0x30,0x30,0x18,0x00},
    ...
    // ;
    {0x00,0x18,0x18,0x00,0x30,0x30,0x18,0x00},
    ...
    // G
    {0x3C,0x66,0xC0,0xC0,0xDE,0x66,0x3E,0x00},
    ...
    // K
    {0xE6,0x6C,0x78,0x70,0x78,0x6C,0xE6,0x00},
    ...
    // g
    {0x00,0x00,0x76,0xCC,0xCC,0xCC,0x7C,0x00},
    ...
    // p
    {0x000,0xDC,0x66,0x66,0x66,0x7C,0x60,0xF0},
    ...
    // y
    {0x00,0x00,0xC6,0xC6,0xC6,0x7E,0x06,0x00},
